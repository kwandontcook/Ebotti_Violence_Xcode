...
class Main_page_col_cell_6: UICollectionViewCell {
    ...
    let alertSettings_button: UIButton = {
        let btn = UIButton()
        btn.contentMode = .scaleAspectFit
        btn.translatesAutoresizingMaskIntoConstraints = false
        btn.setImage(UIImage(named: "msgsettings"), for: .normal)
        return btn
    }()
